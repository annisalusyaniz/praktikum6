...
<html>
 ...
 <body>
  <table border=0>
  <form action="postbiodata.php" method="POST">
   <tr>
    <td>NPM</td>
    <td>:</td>
   ...
   <td>:</td>
    <td>
  <input type=radio name="programstudi" value="TI">Teknik Informatika
  <input type=radio name="programstudi" value="Elektro">Sistem Informasi
    </td>
   </tr>
